                ...
                <div class="row">
                    <div class="col-lg-13">
                        <div class="mt-4 d-grid">
                            <a href = "service-add-employer.php" class="btn btn-primary btn-sm waves-effect waves-light" type="submit"><?php echo $language["Add service"]; ?></a>
                            <br>            
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-editable table-nowrap align-middle table-edits">
                                        ...
                                        <tbody>
                                            <tr data-id="1">
                                                ...
                                                echo "<td>"; 
                                                echo "<a href='service-update-employer.php?service=".$row['sv_id']."' class ='btn btn-outline-secondary btn-sm edit' title ='Edit'><i class='fas fa-pencil-alt'></i></a> &nbsp"; 
                                                echo "<a href='service-delete-employer.php?service=".$row['sv_id']."' class ='btn btn-outline-danger btn-sm Delete' title ='Delete'><i class='bx bx-trash-alt'></i></a> &nbsp";     
                                                ?>
