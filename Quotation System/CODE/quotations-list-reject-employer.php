                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["Rejected List"]; ?></h4><br><br>
                              <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                ...
                                <thead class="table-light table-bordered">
                                  <tr class=text-center>
                                    ...
                                    <th class="align-middle" scope="col"><?php echo $language["Rejection reason"]; ?></th>
                        ...
                        <!-- DISPLAY ALL ITEMS WITH THOSE QUOTATION NUMBERS THAT MATCHES THE CURRENT VALUE -->
                                ...
                                {       
                                    $sql1 ="SELECT * FROM quotation
                                            ...
                                            LEFT JOIN note ON quotation.q_no = note.note_qid
                                            LEFT JOIN status ON quotation.q_status = status.status_desc
                                            WHERE q_status = 'Rejected' ";
                                    ...
                                    <tr class=text-center>
                                        ...
                                        <td><?php echo $row1['note_desc']; ?></td>
                                        <td>
                                            <a href="quotations-details-employer.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-light btn-rounded waves-effect waves-light"><?php echo "View"; ?></a>&nbsp

                                            <a href="quotations-modify3-employer.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-info btn-rounded waves-effect waves-light"><?php echo "Modify"; ?></a>&nbsp
                                        </td>
                                    </tr>
                                    <?php
                                    } ?>
