                    ...
                    <div class="col-xl-8">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <h6 class="mt-0 mb-2 text-white"><i class="mdi mdi-alert-outline me-1"></i><?php echo $language["Pending"]; ?></h6>
                                                <p class="mt-0 mb-2 text-white"><?php echo $row["numberstatus"];?></p>
                                            </div>

                                                <a href='service-request-employee.php' class="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                            ...
                            <div class="col-md-4">
                                <div class="card mini-stats-wid bg-success text-white-50">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <h6 class="mt-0 mb-2 text-white"><i class="mdi mdi-check-all me-1"></i><?php echo $language["Accepted"]; ?></h6>
                                                <p class="mt-0 mb-2 text-white"><?php echo $row1["numberstatus1"];?></p>
                                                </div>

                                                 <a href='service-request-employee-accepted.php' class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                                <span class="avatar-title rounded-circle bg-primary">
                            ...
                            <div class="col-md-4">
                                <div class="card mini-stats-wid bg-danger text-white-50">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <h6 class="mt-0 mb-2 text-white"><i class="mdi mdi-block-helper me-1"></i><?php echo $language["Rejected"]; ?></h6>
                                                <p class="mt-0 mb-2 text-white"><?php echo $row2["numberstatus2"];?></p>
                                            </div>
                                                <a href='service-request-employee-rejected.php' class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                                <span class="avatar-title rounded-circle bg-primary">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="chart-container pie-chart">
                                    <canvas id="bar_chart" style="height: 500px; width: 150%;"></canvas>
                                </div>      
                            </div>
                        </div>
                    </div>
