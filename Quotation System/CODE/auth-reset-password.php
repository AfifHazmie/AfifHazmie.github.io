...
<head>
    <title>Powerec | Reset Password</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p><?php echo $language["Reset your Powerec account password."]; ?></p>
                                    </div>
                                </div>
                            ...
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="mb-3 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                        <label for="new_password"><?php echo $language["New Password"]; ?></label>
                                    ...
                                    <div class="mb-3 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                        <label for="userpassword"><?php echo $language["Confirm password"]; ?></label>
                    ...
                    <div class="mt-5 text-center">
                        <p>Remember It ? <a href="auth-login.php" class="fw-medium text-primary"><?php echo $language[" Sign In here"]; ?></a> </p>
                        <p>© <script>
