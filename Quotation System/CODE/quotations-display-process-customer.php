...
<!-- PHP AREA WARNING -->
    ...
    // Show Status
        $sql1 = " SELECT * FROM status WHERE status_desc = 'Accepted' OR status_desc = 'Rejected' ";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class=" font-size-18">Customer Quotation</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="quotations-display-customer.php">Back</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Customer Approval/Rejection Area</h4>

                                <form class="form-horizontal" method="POST" action="quotations-display-approval-customer.php">
                                  <fieldset>
                                        ...
                                        <tr>
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="return confirm('Are you sure you want to proceed?');" href="quotations-display-approval-customer.php?id=<?php echo $row["q_no"]; ?>" ><button type="submit" class="btn btn-primary btn-rounded w-md waves-effect waves-light"><?php echo "Save"; ?></button></a>
                                                </td>
                                            </tr>
                                      </table>
                                  </fieldset>
