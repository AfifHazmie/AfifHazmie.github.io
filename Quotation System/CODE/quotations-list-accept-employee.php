                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["Accepted List"]; ?></h4><br><br>
                                ...
                                {       
                                    ...
                                    <tr class=text-center>
                                        ...
                                        <td>
                                            ...
                                            <a href="quotations-modify4-employee.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-info btn-rounded waves-effect waves-light"><?php echo $language["Modify"]; ?></a>&nbsp
                                        </td>
                                    </tr>
                                    <?php
                                    } ?>
