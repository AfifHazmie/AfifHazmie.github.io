...
<!-- AREA FOR PHP WRITING ONLY -->
    ...
    <!-- Get Quotation number to display at receipt -->
        <?php 
        $sql = "SELECT COUNT(q_no) AS q FROM quotation ";
    ...
    <!-- Display list of Items inside the specified Quotation -->
        <?php 
        $sql2 ="SELECT * FROM item WHERE i_qno = '$count' ";
        $result2 = mysqli_query($link, $sql2); ?>
    <!-- Display list of Items inside the specified Quotation -->

    <!-- Display notes -->
        <?php
        $sql3 = "SELECT * FROM note WHERE note_qid = '$count' ";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["Receipt"]; ?></h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="invoice-title">
                                    <h4 class="float-end font-size-16">Quotation #<?php echo $count;?></h4>
                                    <div class="mb-4">
                                ...
                                <div class="d-print-none">
                                    <div class="float-end">
                                        ...
                                        <a onclick="return confirm('Quotation will be completed. Continue?');" href="quotations-list-employer.php"><button class="btn btn-primary w-md waves-effect waves-light">Done</button></a>
