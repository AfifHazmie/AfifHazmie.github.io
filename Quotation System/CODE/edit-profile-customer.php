...
<head>
    <title>Powerec | Edit Profile</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        <h5 class="text-primary"><?php echo $language["Edit Profile"]; ?></h5>
                                ...
                                <a href="index.php">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                                            <img src="assets/images/powerec.jpg" alt="" class="rounded-circle" height="70">
                                        </span>
                                    </div>
                                </a>
                            </div>
                            <div class="p-2">
                                <form class="needs-validation" action="functions/editProfileCustomer.func.php" method="post">
                                    ...
                                    <div class="mb-3<?php echo (!empty($useraddress_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <?php if(isset($_SESSION["useraddress_err"])) { ?>
                                        <span class="text-danger"><?php echo $_SESSION["useraddress_err"]; ?></span>
                                        <?php unset($_SESSION["useraddress_err"]); } ?>
                                    </div>
                                    ...
                                    <div class="mb-3 <?php echo (!empty($userphone_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <input type="text" class="form-control" id="userphone" name="userphone" placeholder="Enter phone number" value="<?php echo $row["userphone"]; ?>">
                                    ...
                                    <div class="mt-4 d-grid">
                                        <input type="hidden" name="user_id" value="<?php echo intval($_SESSION["id"]); ?>">
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            <p><a href="customer.php" class="fw-medium text-primary"><?php echo $language["Return to Dashboard"]; ?></a></p>
                            © <script>
