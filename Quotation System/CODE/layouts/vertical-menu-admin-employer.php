...
<!-- ========== Language End ========== -->
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <!-- item-->
                    <a class="dropdown-item" href="edit-profile-employer.php"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile"><?php echo $language["Edit Profile"]; ?></span></a>
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="admin-employer.php" key="t-dashboards"><i class="bx bxs-home"></i>
                ...
                <li>
                    <a href="service-employer.php" class="waves-effect">
                ...
                <li>
                    <a href="service-request-employer.php" class="waves-effect">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="quotations-create-employer.php" key="t-level-1-1"><?php echo $language["New"]; ?></a></li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow" key="t-level-1-2"><?php echo $language["Manage"]; ?>
                                
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="quotations-list-employer.php" key="t-level-2-1"><?php echo $language["Pending"]; ?>
                                    
                                    </a>
                                </li>
                                <li>
                                    <a href="quotations-list-accept-employer.php" key="t-level-2-2"><?php echo $language["Accepted"]; ?>
                                        
                                    </a>
                                </li>
                                <li>
                                    <a href="quotations-list-reject-employer.php" key="t-level-2-3"><?php echo $language["Rejected"]; ?>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow" key="t-level-1-2"><?php echo $language["History"]; ?>
                                
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li>
                                    <a href="quotations-list-complete-employer.php" key="t-level-2-1"><?php echo $language["Completed"]; ?>
                                        
                                    </a>
                                </li>
                                <li><a href="quotations-list-discard-employer.php" key="t-level-2-4"><?php echo $language["Discarded"]; ?>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <li>
                    <a href="feedbacklist-employer.php" key="feedback"><i class="bx bx-comment-dots"></i>
                ...
                <li>
                    <a href="manageUser-employer.php" key="manageuser"><i class="bx bxs-user-detail"></i>
