...
<?php $sv_name = $sv_price =  $sv_desc =  $picture = "";
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <!-- start page title -->
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class=" font-size-18"><?php echo $language["Add service"]; ?></h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="service-employee.php"><?php echo $language["back"]; ?></a></li>
                ...
                <!-- end page title -->
            <form class="from-horizontal" method = "POST" action = "service-add-process-employee.php" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
