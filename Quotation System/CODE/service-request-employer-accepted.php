        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-12">
                                <a href = "service-request-employer.php"type="button" class="btn btn-primary btn-lg waves-effect waves-light"><?php echo $language["Pending"]; ?></a>
                                <a href = "service-request-employer-accepted.php"type="button" class="btn btn-primary btn-lg waves-effect waves-light"><?php echo $language["Accepted"]; ?></a>
                                <a href = "service-request-employer-rejected.php"type="button" class="btn btn-primary btn-lg waves-effect waves-light"><?php echo $language["Rejected"]; ?></a>
                    </div>
                </div>
                <br>
                <!-- end page title -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h5 class="mb-sm-0 font-size-18"><?php echo $language["Accepted Requests"]; ?></h5><br><br> 
                                <form class="form-horizontal">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive">
                                        <thead>
                                            ...
                                            echo "<td>"; 
                                            echo "<a href='service-request-complete-employer.php?request_id=".$row['request_id']."' class ='btn btn-outline-success btn-sm edit'><i class ='dripicons-document-edit'></i></a> &nbsp";
