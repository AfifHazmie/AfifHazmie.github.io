                        ...
                        <!-- DISPLAY ALL ITEMS WITH THOSE QUOTATION NUMBERS THAT MATCHES THE CURRENT VALUE -->
                                ...
                                {       
                                    ...
                                    <tr class=text-center>
                                        ...
                                        <td>
                                            <a href="quotations-details-employer.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-light btn-rounded waves-effect waves-light"><?php echo $language["View"]; ?></a>&nbsp

                                            <a href="quotations-modify1-employer.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-info btn-rounded waves-effect waves-light"><?php echo $language["Modify"]; ?></a>&nbsp

                                            <a onclick="return confirm('Are you sure you want to discard this quotation?');" href="quotations-cancel-employer.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-danger btn-rounded waves-effect waves-light"><?php echo $language["Discard"]; ?></a>
                                        </td>
                                    </tr>
                                    <?php
                                    } ?>
