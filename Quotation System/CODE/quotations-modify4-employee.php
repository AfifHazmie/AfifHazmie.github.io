                            ...
                            <h4 class=" font-size-18"><?php echo $language["Quotation Section"]; ?></h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="quotations-list-accept-employee.php"><?php echo $language["Back"]; ?></a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" method="POST" action="quotations-modify5-employee.php">
                                  <fieldset>
                                        ...
                                        <tr>
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="return confirm('Are you sure you want to proceed?');" ><button type="submit" class="btn btn-primary btn-rounded w-md waves-effect waves-light"><?php echo "Save"; ?></button></a>
                                                </td>
                                            </tr>
                                      </table>
                                  </fieldset>
