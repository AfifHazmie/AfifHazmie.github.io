                                ...
                                <form class="form-horizontal" >
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive">
                                        <thead>
                                            ...
                                            echo "<td>"; 
                                            echo "<a href='service-request-complete-employee.php?request_id=".$row['request_id']."' class ='btn btn-outline-success btn-sm edit'><i class ='dripicons-document-edit'></i></a> &nbsp";
