...
<!-- DEDICATED AREA FOR PHP ALGORITHM -->
    ...
    <!-- Extract information of all qotation with id of this customer -->
        ...
        $sql = "SELECT * FROM quotation
                ...
                LEFT JOIN feedback ON quotation.q_no = feedback.f_qno
                WHERE id = '$id' AND q_status = 'Completed' ";
        ...
        <div class="page-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4"><?php echo $language["Completed List"]; ?></h4>
                                  <!-- Registration Form -->
                                      ...
                                      <table id="datatable" class="table table-bordered dt-responsive">
                                        ...
                                        <thead class="table-light">
                                          <tr class=text-center>
                                            ...
                                            <th class="text-center" scope="col"><?php echo $language["Status"]; ?></th>
                                ...
                                <!-- DISPLAY ALL ITEMS WITH THOSE QUOTATION NUMBERS THAT MATCHES THE CURRENT VALUE -->
                                        ...
                                        { ?>
                                            <tr class=text-center>
                                                ...
                                                <td>
                                                    <a href="quotations-details-customer.php?id=<?php echo $row["q_no"]; ?>" class="btn btn-light btn-rounded waves-effect waves-light"><?php echo $language["View"]; ?></a>&nbsp

                                                <?php 
                                                $sqlCheck = "SELECT COUNT(*) AS count FROM feedback WHERE f_qno = '".$row['q_no']."'";
                                                $resultCheck = mysqli_query($link, $sqlCheck);
                                                $rowCheck = mysqli_fetch_assoc($resultCheck);
                                                ?>

                                                <button type="button" onclick="location.href='feedbackpage-customer.php?id=<?php echo $row['q_no'];?>'" class = 'btn btn-rounded btn-info waves-effect waves-light' <?php if($rowCheck["count"] > 0) {echo 'disabled'; }?>><?php echo $language["Give Feedback"]; ?></button>
