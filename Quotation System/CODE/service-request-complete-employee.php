                            ...
                            <h3 class=" font-size-18"><?php echo $language["Comfirmation"]; ?></h3>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="service-request-employee-accepted.php"><?php echo $language["back"]; ?></a></li>
                ...
                <div class="card-body">
                    <div class="container mt-6">
                        <br>
                          ...
                          <form class="from-horizontal" method = "POST" action = "service-request-complete-process-employee.php">
