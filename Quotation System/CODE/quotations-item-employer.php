                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container"><br><br>
                                    <form class="form-horizontal" method="POST" action="quotations-item-process-employer.php">
                                        <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-10 col-lg-offset-2">
                                                ...
                                                <a href="quotations-note-employer.php" class="btn btn-success"><?php echo $language["Done"]; ?></a>
                                            </div>
                                        </div>
                                        <!-- Buttons -->
