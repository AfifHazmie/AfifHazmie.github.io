...
<?php 
        ...
        {
                echo "<script>alert('Quotation not created. No available accepted request to quote! Returning to create new quotation page.'); window.location.href='quotations-create-employee.php';</script>";
        exit();
        }
