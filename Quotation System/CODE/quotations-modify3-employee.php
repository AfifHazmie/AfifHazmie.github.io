                            ...
                            <h4 class="mb-sm-0 font-size-18">Modify Quotation #<?php echo $qno ?></h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="quotations-list-reject-employee.php"><?php echo $language["Back"]; ?></a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" method="POST" action="quotations-modify3-process-employee.php">
                                    <fieldset>
                                    <!-- Get New Service -->
                                        <div class="row mb-6">
