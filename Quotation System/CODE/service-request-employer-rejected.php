                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h5 class="mb-sm-0 font-size-18"><?php echo $language["Rejected Requests"]; ?></h5><br><br> 
                                <form class="form-horizontal">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive">
                                        <thead>
                                            ...
                                            echo "<td>"; 
                                            echo "<a href='service-request-update-employer.php?request_id=".$row['request_id']."' class ='btn btn-outline-primary btn-sm edit'><i class ='dripicons-document-edit'></i></a> &nbsp";
