            ...
            <div class="card">
                <div class="card-body">
                    <div class="container mt-6">
                                        ...
                                        <h3><?php echo $language["Request Detail"]; ?></h3>
                                            <div class="page-title-right">
                                                <ol class="breadcrumb m-0">
                                                    <li class="breadcrumb-item"><a href="service-request-employer.php"><?php echo $language["back"]; ?></a></li>
                        ...
                        <!-- end page title -->
                          <br>
                          <form class="from-horizontal" method = "POST" action = "service-request-process-employer.php">
