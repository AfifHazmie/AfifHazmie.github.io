                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                <form class="needs-validation" action="functions/editProfileEmployer.func.php" method="post">
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            <p><a href="admin-employer.php" class="fw-medium text-primary"><?php echo $language["Return to Dashboard"]; ?></a></p>
                            © <script>
