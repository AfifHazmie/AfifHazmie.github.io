...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($useremail_err) && empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty ($userphone_err)) {
        ...
        $sql = "INSERT INTO users (useremail, username, password, useraddress, userphone, u_type, token) VALUES (?,?,?,?,?,1,?)";
...
window.location.href='manageUser-employee.php';
</script>";
            } else {
...
<head>
    <title>Powerec | Add Employee</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        <h5 class="text-primary"><?php echo $language["Admin (Employee) Registration"]; ?></h5>
                            ...
                            <div class="p-2">
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="mt-4 d-grid">
                                        <button class="btn btn-primary waves-effect waves-light" type="submit"><?php echo $language["Add Employee"]; ?></button>
                                    </div>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            <p><a href="manageUser-employee.php" class="fw-medium text-primary"><?php echo $language["Return to user list"]; ?></a></p>
                            © <script>
