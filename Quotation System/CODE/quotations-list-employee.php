                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h4 class="mb-sm-0 font-size-18"><?php echo $language["Pending List"]; ?></h4><br><br> 
                              <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                <!-- Table Header -->
                                <thead class="table-light table-bordered">
                                  <tr class=text-center>
                                    <th class="align-middle" scope="col"><?php echo "Quote ID" ; ?></th>
                                    ...
                                    <th class="align-middle" scope="col"><?php echo $language["Date Created"]; ?></th>
                        ...
                        <!-- DISPLAY ALL ITEMS WITH THOSE QUOTATION NUMBERS THAT MATCHES THE CURRENT VALUE -->
                                ...
                                {       
                                    ...
                                    <tr class=text-center>
                                        ...
                                        <td><?php echo $row1['q_date']; ?></td>
                                        <td>
                                            <a href="quotations-details-employee.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-light btn-rounded waves-effect waves-light"><?php echo $language["View"]; ?></a>&nbsp

                                            <a href="quotations-modify1-employee.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-info btn-rounded waves-effect waves-light"><?php echo $language["Modify"]; ?></a>&nbsp

                                            <a onclick="return confirm('Are you sure you want to discard this quotation?');" href="quotations-cancel-employee.php?id=<?php echo $row1["q_no"]; ?>" class="btn btn-danger btn-rounded waves-effect waves-light"><?php echo $language["Discard"]; ?></a>
                                        </td>
                                    </tr>
                                    <?php
                                    } ?>
