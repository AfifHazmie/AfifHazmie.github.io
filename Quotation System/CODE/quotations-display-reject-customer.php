...
<!-- DEDICATED AREA FOR PHP ALGORITHM -->
    ...
    <!-- Extract information of all qotation with id of this customer -->
        ...
        $sql = "SELECT * FROM quotation
                ...
                WHERE id = '$id' AND q_status = 'Rejected' ";
        ...
        <div class="page-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4"><?php echo $language["Rejected List"]; ?></h4>
                                  <!-- Registration Form -->
                                ...
                                <!-- DISPLAY ALL ITEMS WITH THOSE QUOTATION NUMBERS THAT MATCHES THE CURRENT VALUE -->
                                        ...
                                        { ?>
                                            <tr class=text-center>
                                                ...
                                                <td>
                                                    <a href="quotations-details-reject-customer.php?id=<?php echo $row["q_no"]; ?>" class="btn btn-light waves-effect waves-light"><?php echo "View"; ?></a>&nbsp
                                                </td>
                                            </tr>
                                        <?php
                                        }
