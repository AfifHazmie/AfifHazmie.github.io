                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Modifying Item List</h4></div></div></div>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="quotations-list-employer.php"><?php echo $language["Back"]; ?></a></li>
...
<!-- DISPLAY ALL ITEMS WITH THOSE QUOTATION NUMBERS THAT MATCHES THE CURRENT VALUE -->
            <?php if($count != 0)
            {
                ...
                echo "<td>";
                echo "<a href = 'quotations-item-destroy-employer.php?id=".$row1['i_no']."' class = 'btn btn-danger'> Cancel</a>";
                echo "</td>";
                echo "</tr>";
                }
                mysqli_close($link);
...
<form class="form-horizontal" method="POST" action="quotations-item-process-employer.php"><fieldset>
<h4 class="mb-sm-0 font-size-18">Item Form</h4><br><br>
    ...
    <a href="quotations-receipt-employer.php"><button type="button" class="btn btn-success waves-effect waves-light">Done</button> </a></div></div>
    <!-- Buttons -->
